...
module.exports = class {
    ...
    http(req, res, next = () => res.end('')) {
        ...
        if (proxyURL.href.startsWith('https://') || proxyURL.href.startsWith('http://')); else return res.end('Page Not Found!');
        ...
        if (isBlocked) return res.end('The URL you are trying to access is not permitted for use on this proxy, use the correct proxy for that site. ヾ(*ФωФ)βyё βyё☆彡')
